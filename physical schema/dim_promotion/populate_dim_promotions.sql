...
VALUES (1, 101, 'Discount', 'Frequent Flyers', 'Email', TO_DATE('2025-03-01', 'YYYY-MM-DD'), TO_DATE('2025-03-31', 'YYYY-MM-DD'), 'Y', 15.00);
...
INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (9, 109, 'Senior Citizen Offer', 'Senior Citizens', 'Call Center', TO_DATE('2025-02-01', 'YYYY-MM-DD'), TO_DATE('2025-02-31', 'YYYY-MM-DD'), 'N', 30.00);

INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (10, 110, 'Family Offer', 'Families', 'Email', TO_DATE('2025-03-15', 'YYYY-MM-DD'), TO_DATE('2025-06-15', 'YYYY-MM-DD'), 'Y', 18.00);

INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (11, 111, 'Holiday Discount', 'All Customers', 'Website', TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-01-31', 'YYYY-MM-DD'), 'N', 40.00);

INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (12, 112, 'Exclusive Offer', 'Platinum Members', 'SMS', TO_DATE('2025-05-01', 'YYYY-MM-DD'), TO_DATE('2025-05-10', 'YYYY-MM-DD'), 'Y', 10.00);

INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (13, 113, 'Birthday Special', 'Loyal Customers', 'Email', TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-12-31', 'YYYY-MM-DD'), 'Y', 12.50);

INSERT INTO dim_promotions (promotion_id, promotion_key, promotion_type, promotion_target_segment, promotion_channel, promotion_start_date, promotion_end_date, is_current, discount) 
VALUES (14, 114, 'Weekend Getaway', 'All Customers', 'Mobile App', TO_DATE('2025-03-08', 'YYYY-MM-DD'), TO_DATE('2025-03-10', 'YYYY-MM-DD'), 'Y', 22.00);
